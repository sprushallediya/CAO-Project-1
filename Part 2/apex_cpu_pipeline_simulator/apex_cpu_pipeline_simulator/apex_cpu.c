...
APEX_decode(APEX_CPU *cpu)
{
    if (cpu->decode.has_insn)
    {
        ...
        // Check operand readiness using scoreboarding
...
APEX_memory(APEX_CPU *cpu)
{
    if (cpu->memory.has_insn)
    {
        switch (cpu->memory.opcode)
        {
            ...
            // These just pass along, no memory action
            case OPCODE_ADD:
            case OPCODE_SUB:
            case OPCODE_MUL:
            case OPCODE_DIV:
    ...
    if (cpu->writeback.has_insn)
    {
        switch (cpu->writeback.opcode)
        {
            ...
            case OPCODE_LOAD:
            {
                ...
                cpu->register_valid[cpu->writeback.rd] = TRUE;
                break;
            }
            ...
            case OPCODE_JUMP:
            case OPCODE_BAL:
                // These don't write back to registers
                break;
...
APEX_cpu_init(const char *filename)
{
    ...
    memset(cpu->register_valid, TRUE, sizeof(int) * REG_FILE_SIZE);
